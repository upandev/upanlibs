...
namespace upanui {
  ImageCanvas::ImageCanvas(const Image& image, ImageComposeType composeType,
    ...
    : RectangleCanvas(x, y, width, height, horizontalPlacementType, UIObjectImpl::getVerticalPlacementType()), _image(new Image(image)), _composeType(composeType) {
  }

  ImageCanvas::ImageCanvas(Image* inImage, ImageComposeType composeType,
                           int x, int y, int width, int height, HorizontalPlacementType horizontalPlacementType, VerticalPlacementType verticalPlacementType)
      : RectangleCanvas(x, y, width, height, horizontalPlacementType, verticalPlacementType), _image(inImage), _composeType(composeType) {
  }
