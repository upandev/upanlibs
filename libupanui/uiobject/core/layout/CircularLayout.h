...
namespace upanui {
  ...
  public:
    ...
    void fill() override;
  private:
    void plotLine(int x, int y, int r, const FrameBuffer& framebuffer, uint32_t color);
    void plotPixel(int x, int y, int r, const FrameBuffer& framebuffer, uint32_t color);
  };
}