...
namespace upanui {
  IconButton::IconButton(const ImageResource& imageResource, const ImageComposeType composeType,
    ...
    : Button(x, y, width, height, horizontalPlacementType, verticalPlacementType), _imageResource(imageResource), _composeType(composeType) {
  }
  ...
  void IconButton::init() {
    {
      ...
      UIObjectFactory::createImageCanvas(*this, _imageResource, _composeType, ix, iy, iw, ih, HorizontalPlacementType::ABSOLUTE, VerticalPlacementType::ABSOLUTE);
    }
